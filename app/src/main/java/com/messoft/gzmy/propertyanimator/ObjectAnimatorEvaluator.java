...
public class ObjectAnimatorEvaluator implements TypeEvaluator {
    ...
    public Object evaluate(float fraction, Object startValue, Object endValue) {
        ...
        if (mCurrentRed != endRed) {
            mCurrentBlue = getCurrentColor(startRed, endRed, colorDiff, 0, fraction);
